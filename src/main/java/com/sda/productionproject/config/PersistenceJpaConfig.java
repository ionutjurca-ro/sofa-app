...
public class PersistenceJpaConfig {
    ...
    public static final String MODEL_PACKAGE = "com.sda.productionproject.model";
    public static final String REPOSITORY_PACKAGE = "com.sda.productionproject.repository";
